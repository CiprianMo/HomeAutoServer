...
int main(int argc, char *argv[]) {
  ...
  config = cmd_ln_init(NULL, ps_args(), TRUE,                   // Load the configuration structure - ps_args() passes the default values
    ...
    "-lm", "/usr/local/share/pocketsphinx/model/en-us/en-us.lm.bin",                                         // custom language model (file must be present)
    "-dict", "/usr/local/share/pocketsphinx/model/en-us/cmuditct-en-us.dic",                                      // custom dictionary (file must be present)
